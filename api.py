...
api.add_resource(ClusterSummary, '/clustering/summary/kmeans', endpoint="dbscan-summary")
api.add_resource(ClusterSummary, '/clustering/summary/kmeans', endpoint="agglomerative-summary")
api.add_resource(ClusterSummary, '/clustering/summary/kmeans', endpoint="birch-summary")
